            ...
            <div className='w-[95%] flex items-center justify-between'>
                ...
                <Link to="/" >
                    <div className=' bg-black p-[10px] rounded-full md:p-[14px]'>
                        <p className=' text-white text-[20px] font-semibold md:text-[20px]'>AG</p>
                    </div>
                </Link>
                </div>
                <ul className='md:initial md:flex justify-center gap-5 text-xl font-semibold w-1/3 md:text-[20px]'>
                ...
                <div className=' flex justify-center gap-4 text-[28px] w-1/3 md:text-[30px]'>
